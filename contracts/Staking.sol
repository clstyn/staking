...
contract Staking{
    ...
    function stakeEther(uint numDays) external payable {
        ...
        positions[currentPositionId] = Position(
            ...
            msg.sender,
            block.timestamp,
            block.timestamp + (numDays * 1 days), //dikali 1 days supaya tidak error di solidity
            tiers[numDays], //interest rates
            msg.value,
    ...
    function closePosition(uint positionId) external {
        require(positions[positionId].walletAddress == msg.sender, "Only position creator may modify positions");
