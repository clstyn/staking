...
describe('Staking', function () {
    ...
    describe('stakeEther', function () {
        it('transfers ether', async function () {
            ...
            //test changes in signer ether balance
            expect(
                await signer1.getBalance()
            ).to.equal(
                signerBalance.sub(transferAmount).sub(gasUsed)
            )
            //test changes in contract ether balance
            expect(
    ...
    describe('getInterestRate', function () {
        it('returns the interest rate for a specific blockchain', async function () {
    ...
    describe('getPositionById', function() {
        it('returns data about a specific position, given a positionId', async function () {
            const provider = waffle.provider;
    ...
    describe('getPositionIdsForAddress', function () {
        it('returns a list of positionIds created by a specifis address', async function () {
            let data;
            let transaction;
    ...
    describe('changeUnlockDate', function () {
        describe('owner', function(){
            it('changes the unlockDate', async function() {
